...
const CONFIG = {
  ...
  // --- STATS ---
  stats: [
    { value: "$2B+", label: "Assets Under Custody" },
    { value: "50+", label: "Supported Digital Assets" },
  ...
  contact: {
    title: "Get in Touch",
    subtitle: "Ready to take your digital asset strategy to the next level?",
    cta: "Schedule a Call"
  },
